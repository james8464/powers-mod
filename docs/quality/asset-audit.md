...
| `lang/en_us.json` | lang | `9e4c3df784d1` | pass | JSON decoded; references are covered by strict resource validation. |
...
| `sounds.json` | sounds.json | `89e84f729384` | pass | JSON decoded; references are covered by strict resource validation. |
