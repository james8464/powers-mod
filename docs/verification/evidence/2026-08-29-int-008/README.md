...
`d629acb8c86beff3ef52dacb8fd85f12d00ea57e`, with immutable base `98b181671b1514a3695ccb8f1ba1985092bce3dd`.
...
- Exact-SHA capture: all 163 required GameTests passed.
- Literal full check: all 163 GameTests, 1,835 JUnit tests across
  424 raw XML suites, and 239 Python tests passed.
...
```text
JAVA_HOME=<java25> ./gradlew runGameTest -Pint008ImplementationSha=d629acb8c86beff3ef52dacb8fd85f12d00ea57e --rerun-tasks --no-daemon --console=plain
