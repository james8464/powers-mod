...
| `use` | `main` | Uses the main-hand item through vanilla client interaction handling, or sends the same authenticated emergency return as right-click while controlling a remote vessel. |
