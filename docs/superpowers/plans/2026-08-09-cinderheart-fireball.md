...
- [x] Replace delayed callbacks and mutable-owner damage with bounded server-owned Cinderheart state.
- [x] Add safe spawn, charge, launch, trail, reflection, impact, steam, protection, terrain, and exact cleanup.
- [x] Wire lifecycle and tick ownership through `PowerAbilityRuntime` and route the owned projectile mixin through the runtime.

## Task 3: Presentation and evidence

- [x] Add dedicated opening, charge, hover, launch, wake, reflection, refusal, terminal, steam, impact, interruption, and expiry choreography.
