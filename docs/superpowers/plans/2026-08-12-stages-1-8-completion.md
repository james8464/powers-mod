...
- [ ] `VFX-011`: implementation and reviewed evidence are provisionally complete; keep open until the protected QA-006 soak ends and the literal aggregate gate reruns without host-load interference.
