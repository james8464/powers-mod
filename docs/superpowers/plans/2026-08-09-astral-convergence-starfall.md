# Astral Convergence Starfall implementation plan

## Task 1: Pure storm rules

- [x] Write failing tests for phases, strike schedule, rank counts, offsets, falloff, hit limits, tracking, counter priority, pressure, and lifecycle.
- [x] Implement `StarfallRules` and run its focused suite.
