...
The [VFX-011 exact visual-audit bundle](docs/verification/evidence/2026-08-21-vfx-011/README.md) remains open. Its 970-asset audit, 90 pixel pages, and two-client locator/advancement proof are accepted; the historical 971-frame gallery is navigation-only because its raw files and original emitted metadata were not retained. A fresh post-soak raw capture, explicit digest-bound review, and literal aggregate are required. The enhanced Light Realm sky is still separate VFX-009 work.
