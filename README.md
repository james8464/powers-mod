...
The [VFX-011 exact visual-audit bundle](docs/verification/evidence/2026-08-21-vfx-011/README.md) is intentionally provisional. Its 970-asset audit, 90 pixel pages, 971 production-client screenshots, and two-client locator/advancement proof are accepted, but the backlog row remains open until a literal aggregate can rerun after the protected QA-006 soak releases the host. The enhanced Light Realm sky is still separate VFX-009 work.
