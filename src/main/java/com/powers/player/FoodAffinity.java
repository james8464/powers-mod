...
public final class FoodAffinity {
	...
	private static final Set<String> NORMAL_FOODS = Set.of(
			...
			"imported_food_slab_pork_cooked", "imported_food_stew_sweetpod", "imported_food_butter");
	...
	private static final Set<String> ABNORMAL_FOODS = Set.of(
			...
			"imported_food_bryony", "imported_food_dough");
	...
	private static final Set<String> NEUTRAL_FOODS = Set.of(
			...
			"imported_food_cornkernels", "imported_food_cranberries", "imported_food_fig", "imported_food_fisherberries",
			"imported_food_garlic", "imported_food_grapes", "imported_food_hardtack", "imported_food_leek",
			"imported_food_lentils", "imported_food_lettuce", "imported_food_mulberries", "imported_food_mungbean",
			"imported_food_onion", "imported_food_pantao", "imported_food_pepper", "imported_food_pile_rice",
			"imported_food_prickleberries", "imported_food_radish", "imported_food_raspberries", "imported_food_redbeans",
			"imported_food_silver_pear", "imported_food_slice_cantaloupe", "imported_food_slice_eggplant", "imported_food_slice_honeydew",
			"imported_food_slice_hornedmelon", "imported_food_slice_squash", "imported_food_slice_wintermelon", "imported_food_spices",
			"imported_food_spinach", "imported_food_strawberries", "imported_food_sunberries", "imported_food_sweetpod",
			"imported_food_tomatillos", "imported_food_tomato", "imported_food_uradbean", "imported_food_wisdomfruit");
