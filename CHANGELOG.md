...
- Closed VFX-011 with a dated exact-build successor: all 970 assets and 90 deterministic pixel pages were explicitly reviewed; a fresh 971-frame gallery retains every original raw PNG and client-emitted metadata row; 2,082 digest-bound decisions preserve 956 raw and 49 contact-page limitations without inferred PASS; and focused, 131/131 GameTest, 1,680-test `check`, checksum, and privacy gates pass. The historical provisional bundle is preserved and VFX-009 stays separate and open.
